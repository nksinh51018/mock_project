        ...
        return (
            <>
                <Row>
                    ...
                    <Col span={8}>
                    {/* <span style={{ marginLeft: 87 }}>{customerItem !== undefined ? customerItem.pay_status === "1" ? <Tag color='success'>Đã thanh toán</Tag> : customerItem.pay_status === "2" ? <Tag color='magenta'>Chưa tạo phiếu</Tag> : <Tag color='warning'>Chưa thanh toán</Tag> : ''} </span>
                     */}
                    </Col>
                    <Col span={8}>
