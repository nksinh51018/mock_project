...
public class MessageServiceImpl implements MessageService {
    ...
    public Map<String, Object> getListMessage(String email, int page, int size) {
        ...
        Page<Message> messages = messageRepository.getMessagesByEmail(email,paging);
        ...
        map.put("currentPage", messages.getNumber() + 1);
        map.put("totalItems", messages.getTotalElements());
        map.put("totalPages", messages.getTotalPages());
        return map;
    }
